...
const defaultSOPs: SOP[] = [
  {
    ...
    steps: [
      { id: '1', text: 'Create lead magnet', completed: false },
      { id: '2', text: 'Test email sequences', completed: false },
      { id: '3', text: 'Launch email campaign', completed: false },
      { id: '4', text: 'Set up landing page', completed: false },
      { id: '5', text: 'Configure email automation', completed: false },
