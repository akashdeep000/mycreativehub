                ...
                {days.map((day, index) => {
                  ...
                  return (
                    <div
                      key={`day-${day}`}
                      data-day={day}
                      className={`h-40 border-r border-b border-gray-200 last:border-r-0 relative min-w-0 overflow-hidden [clip-path:inset(0)] p-0 sm:p-1 bg-white cursor-pointer transition-colors ${
