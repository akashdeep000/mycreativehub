...
export default function DailyFocus() {
  ...
  const priorityConfig = {
    must: { 
      ...
      icon: CheckCircle,
      bgColor: "bg-[#f77cb4]", 
      borderColor: "border-[#f77cb4]",
      textColor: "text-white",
      iconColor: "text-white",
      checkboxColor: "data-[state=checked]:bg-white data-[state=checked]:border-white data-[state=checked]:text-[#f77cb4]",
      badgeBg: "bg-white",
      badgeText: "text-[#f77cb4]",
    ...
    should: { 
      ...
      icon: Clock,
      bgColor: "bg-[#c29bff]", 
      borderColor: "border-[#c29bff]",
      textColor: "text-white",
      iconColor: "text-white",
      checkboxColor: "data-[state=checked]:bg-white data-[state=checked]:border-white data-[state=checked]:text-[#c29bff]",
      badgeBg: "bg-white",
      badgeText: "text-[#c29bff]",
    ...
    could: { 
      ...
      icon: Lightbulb,
      bgColor: "bg-[#8be0c0]", 
      borderColor: "border-[#8be0c0]",
      textColor: "text-white",
      iconColor: "text-white",
      checkboxColor: "data-[state=checked]:bg-white data-[state=checked]:border-white data-[state=checked]:text-[#8be0c0]",
      badgeBg: "bg-white",
      badgeText: "text-[#8be0c0]",
