...
export const passwordResetCodes = pgTable(
  ...
  (table) => [
    index("password_reset_codes_email_expires_idx").on(
      table.email,
      table.expiresAt,
    ),
  ],
...
export const resetSessions = pgTable(
  "reset_sessions",
  {
...
export const taskCompletionLog = pgTable(
  "task_completion_log",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
  ...
  (table) => ({
    uniqueTaskDate: uniqueIndex("unique_task_date").on(
      table.taskId,
      table.dateCompleted,
    ),
  }),
...
export const workflowTemplateInstances = pgTable(
  ...
  (table) => ({
    userTemplateUniqueIdx: uniqueIndex(
      "workflow_template_instances_userid_templatetype_unique",
    ).on(table.userId, table.templateType),
  }),
);
...
export const workflowTemplateFiles = pgTable("workflow_template_files", {
  id: serial("id").primaryKey(),
  templateInstanceId: integer("template_instance_id")
    .notNull()
...
export const inspirationBoardImages = pgTable("inspiration_board_images", {
  id: serial("id").primaryKey(),
  boardId: integer("board_id").references(() => inspirationBoards.id, {
    onDelete: "cascade",
  }),
...
export const socialMediaStrategies = pgTable(
  ...
  (table) => ({
    uniqueUserId: uniqueIndex("social_media_strategy_user_unique").on(
      table.userId,
    ),
  }),
);
...
export const toolkitModulesRelations = relations(
  toolkitModules,
  ({ many }) => ({
...
export const userToolkitDataRelations = relations(
  userToolkitData,
  ({ one }) => ({
    user: one(users, {
...
export const dailyFocusTasksRelations = relations(
  dailyFocusTasks,
  ({ one }) => ({
    user: one(users, {
...
export const userTemplateInstancesRelations = relations(
...
export const workflowTemplateInstancesRelations = relations(
...
export const workflowTemplateFilesRelations = relations(
...
export const inspirationBoardImagesRelations = relations(
...
export const inspirationBoardNotesRelations = relations(
...
export const socialMediaStrategiesRelations = relations(
...
// Insert schemas
export const insertDailyFocusTaskSchema = createInsertSchema(dailyFocusTasks)
  .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export const insertTaskCompletionLogSchema = createInsertSchema(
  taskCompletionLog,
).omit({
  id: true,
  createdAt: true,
...
export const insertUserToolkitDataSchema = createInsertSchema(
  userToolkitData,
).omit({
  id: true,
  createdAt: true,
...
export const insertCourseWhitelistSchema = createInsertSchema(
  courseWhitelist,
).omit({
  id: true,
  createdAt: true,
...
export const insertUserTemplateInstanceSchema = createInsertSchema(
  userTemplateInstances,
).omit({
  id: true,
  createdAt: true,
...
export const insertWorkflowTemplateInstanceSchema = createInsertSchema(
  workflowTemplateInstances,
).omit({
  id: true,
  createdAt: true,
...
export const insertWorkflowTemplateFileSchema = createInsertSchema(
  workflowTemplateFiles,
).omit({
  id: true,
  uploadedAt: true,
...
export const insertInspirationBoardSchema = createInsertSchema(
  inspirationBoards,
).omit({
  id: true,
  createdAt: true,
...
export const insertInspirationBoardImageSchema = createInsertSchema(
  inspirationBoardImages,
).omit({
  id: true,
  createdAt: true,
...
export const insertInspirationBoardNoteSchema = createInsertSchema(
  inspirationBoardNotes,
).omit({
  id: true,
  createdAt: true,
...
export const insertSocialMediaStrategySchema = createInsertSchema(
  socialMediaStrategies,
).omit({
  id: true,
  createdAt: true,
...
export const monthlyContentCalendar = pgTable(
  ...
  (table) => ({
    uniqueUserYearMonth: uniqueIndex("unique_user_year_month").on(
      table.userId,
      table.year,
      table.month,
    ),
...
export const contentPerformanceStrategy = pgTable(
  "content_performance_strategy",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
      .notNull()
...
export const seasonalityTimeline = pgTable(
  "seasonality_timeline",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
      .notNull()
  ...
  (table) => ({
    uniqueUserYear: uniqueIndex("unique_user_year_seasonality").on(
      table.userId,
      table.year,
    ),
  }),
...
export const quarterDetailPlans = pgTable(
  "quarter_detail_plans",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
      .notNull()
  ...
  (table) => ({
    uniqueUserYearQuarter: uniqueIndex("unique_user_year_quarter").on(
      table.userId,
      table.year,
      table.quarter,
    ),
...
export const productComponentChecklists = pgTable(
  "product_component_checklists",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
      .notNull()
...
export const financeTransactions = pgTable(
  ...
  (table) => [
    index("finance_transactions_user_year_month_idx").on(
      table.userId,
      table.year,
      table.month,
    ),
...
export const moneyMapMonths = pgTable(
  "money_map_months",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
  ...
  (table) => [
    uniqueIndex("money_map_months_user_year_month_idx").on(
      table.userId,
      table.year,
      table.month,
    ),
...
export const insertMonthlyContentCalendarSchema = createInsertSchema(
...
export const insertContentBatchingPlannerSchema = createInsertSchema(
...
export const insertContentStatusTrackerSchema = createInsertSchema(
...
export const insertRepurposingToolkitSchema = createInsertSchema(
  repurposingToolkit,
).omit({
  id: true,
  createdAt: true,
...
export const insertContentPerformanceStrategySchema = createInsertSchema(
...
export const insertPerformanceTrackingTableSchema = createInsertSchema(
...
export const insertSeasonalityTimelineSchema = createInsertSchema(
  seasonalityTimeline,
).omit({
  id: true,
  createdAt: true,
...
export const insertQuarterDetailPlanSchema = createInsertSchema(
  quarterDetailPlans,
).omit({
  id: true,
  createdAt: true,
...
export const insertProductComponentChecklistSchema = createInsertSchema(
...
export const insertProfitCalculatorSchema = createInsertSchema(
  profitCalculator,
).omit({
  id: true,
  createdAt: true,
...
export const insertPrelaunchTimelinePlannerSchema = createInsertSchema(
...
export const insertLaunchGrowthPlanSchema = createInsertSchema(
  launchGrowthPlans,
).omit({
  id: true,
  createdAt: true,
...
export const insertFinanceTransactionSchema = createInsertSchema(
  financeTransactions,
).omit({
  id: true,
  createdAt: true,
...
export const insertMoneyMapMonthSchema = createInsertSchema(
  moneyMapMonths,
).omit({
  id: true,
  createdAt: true,
...
export const insertAutomationToolkitSchema = createInsertSchema(
  automationToolkit,
).omit({
  id: true,
  createdAt: true,
...
export const insertFocusSessionLogSchema = createInsertSchema(
  focusSessionLogs,
).omit({
  id: true,
  createdAt: true,
...
export type InsertTaskCompletionLog = z.infer<
  typeof insertTaskCompletionLogSchema
>;
...
export type InsertUserTemplateInstance = z.infer<
  typeof insertUserTemplateInstanceSchema
>;
export type WorkflowTemplateInstance =
  typeof workflowTemplateInstances.$inferSelect;
export type InsertWorkflowTemplateInstance = z.infer<
  typeof insertWorkflowTemplateInstanceSchema
>;
export type WorkflowTemplateFile = typeof workflowTemplateFiles.$inferSelect;
export type InsertWorkflowTemplateFile = z.infer<
  typeof insertWorkflowTemplateFileSchema
>;
export type InspirationBoard = typeof inspirationBoards.$inferSelect;
export type InsertInspirationBoard = z.infer<
  typeof insertInspirationBoardSchema
>;
export type InspirationBoardImage = typeof inspirationBoardImages.$inferSelect;
export type InsertInspirationBoardImage = z.infer<
  typeof insertInspirationBoardImageSchema
>;
export type InspirationBoardNote = typeof inspirationBoardNotes.$inferSelect;
export type InsertInspirationBoardNote = z.infer<
  typeof insertInspirationBoardNoteSchema
>;
...
export type InsertSocialMediaStrategy = z.infer<
  typeof insertSocialMediaStrategySchema
>;
export type ResourceLibraryItem = typeof resourceLibrary.$inferSelect;
export type InsertResourceLibraryItem = z.infer<
  typeof insertResourceLibrarySchema
>;
...
export type InsertMonthlyContentCalendar = z.infer<
  typeof insertMonthlyContentCalendarSchema
>;
export type ContentBatchingPlanner = typeof contentBatchingPlanner.$inferSelect;
export type InsertContentBatchingPlanner = z.infer<
  typeof insertContentBatchingPlannerSchema
>;
export type ContentStatusTracker = typeof contentStatusTracker.$inferSelect;
export type InsertContentStatusTracker = z.infer<
  typeof insertContentStatusTrackerSchema
>;
export type RepurposingToolkit = typeof repurposingToolkit.$inferSelect;
export type InsertRepurposingToolkit = z.infer<
  typeof insertRepurposingToolkitSchema
>;
export type ContentPerformanceStrategy =
  typeof contentPerformanceStrategy.$inferSelect;
export type InsertContentPerformanceStrategy = z.infer<
  typeof insertContentPerformanceStrategySchema
>;
export type PerformanceTrackingTable =
  typeof performanceTrackingTable.$inferSelect;
export type InsertPerformanceTrackingTable = z.infer<
  typeof insertPerformanceTrackingTableSchema
>;
export type SeasonalityTimeline = typeof seasonalityTimeline.$inferSelect;
export type InsertSeasonalityTimeline = z.infer<
  typeof insertSeasonalityTimelineSchema
>;
export type QuarterDetailPlan = typeof quarterDetailPlans.$inferSelect;
export type InsertQuarterDetailPlan = z.infer<
  typeof insertQuarterDetailPlanSchema
>;
export type ProductComponentChecklist =
  typeof productComponentChecklists.$inferSelect;
export type InsertProductComponentChecklist = z.infer<
  typeof insertProductComponentChecklistSchema
>;
export type ProfitCalculator = typeof profitCalculator.$inferSelect;
export type InsertProfitCalculator = z.infer<
  typeof insertProfitCalculatorSchema
>;
export type PrelaunchTimelinePlanner =
  typeof prelaunchTimelinePlanner.$inferSelect;
export type InsertPrelaunchTimelinePlanner = z.infer<
  typeof insertPrelaunchTimelinePlannerSchema
>;
export type LaunchGrowthPlan = typeof launchGrowthPlans.$inferSelect;
export type InsertLaunchGrowthPlan = z.infer<
  typeof insertLaunchGrowthPlanSchema
>;
...
export type InsertFinanceTransaction = z.infer<
  typeof insertFinanceTransactionSchema
>;
...
export type InsertAutomationToolkit = z.infer<
  typeof insertAutomationToolkitSchema
>;
...
export const calendarV2 = pgTable(
  "calendar_v2",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
  ...
  (table) => [
    uniqueIndex("calendar_v2_user_year_month_idx").on(
      table.userId,
      table.year,
      table.month,
    ),
...
export const calendarV3 = pgTable(
  "calendar_v3",
  {
    id: serial("id").primaryKey(),
    userId: varchar("user_id")
  ...
  (table) => [
    uniqueIndex("calendar_v3_user_year_month_idx").on(
      table.userId,
      table.year,
      table.month,
    ),
...
export const insertGlobalColorKeysSchema = createInsertSchema(
  globalColorKeys,
).omit({
  id: true,
  createdAt: true,
...
export const insertTimeBlockingColorKeysSchema = createInsertSchema(
...
export type InsertTimeBlockingColorKeys = z.infer<
...
export const automationPrompts = pgTable(
  ...
  (table) => [index("automation_prompts_user_id_idx").on(table.userId)],
);

// Time Blocking Events - Proper normalized table for events
export const timeBlockingEvents = pgTable(
  "time_blocking_events",
  {
  ...
  (table) => [
    index("time_blocking_events_user_start_idx").on(
      table.userId,
      table.startTime,
    ),
...
export const insertAutomationPromptSchema = createInsertSchema(
  automationPrompts,
).pick({
  userId: true,
  trigger: true,
...
export const insertTimeBlockingEventSchema = createInsertSchema(
  timeBlockingEvents,
).omit({
  id: true,
  createdAt: true,
...
export const insertCheatSheetDocSchema = createInsertSchema(
  cheatSheetDocs,
).omit({
  createdAt: true,
  updatedAt: true,
...
export type InsertAutomationPrompt = z.infer<
  typeof insertAutomationPromptSchema
>;
